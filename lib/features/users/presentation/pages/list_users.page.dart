...
class _UserListPageState extends ConsumerState<UserListPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      ref.read(userControllerProvider.notifier).searchUsers();
    });
  }
    ...
    return Scaffold(
      ...
      body: Row(
        ...
        children: [
          ...
          Expanded(child: _buildBody(userState)),
        ],
      ),
    );
  }
  ...
  Widget _buildBody(UserState userState) {
    ...
    if (userState.error != null) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text(userState.error!, style: const TextStyle(color: Colors.red)),
    ...
    final userList = userState.users;
